...
box = Box(Frame.worldXY(),3000,100,100)
box_2 = Box(Frame.worldXY(),100,1000,100)
mesh = Mesh.from_vertices_and_faces(box.vertices, box.faces)
...
#vertices_id
vertices_id = mesh.face_vertices(face_id)
print (vertices_id)
...
#yaxis
a = mesh.face_centroid(face_id)
n = mesh.face_normal(face_id)
...
#T = Transformation.from_frame_to_frame(f1, Frame_bool)
...
artist_2.draw_lines(bool_lines)
